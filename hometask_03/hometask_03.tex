...
\task Какое минимальное количество ходов необходимо для белых, чтобы поставить мат?
...
\taskk Найдите мат в два хода за белых.
...
\task Каким образом белым выиграть?
\begin{nscenter}
    \chessboard[
        showmover=true,
        borderleft=true,
...
\task Найти выигрышный ход за белых.
\begin{nscenter}
    \chessboard[
        showmover=true,
        % mover=b,
...
\task Каким образом белым поймать черного коня?
\begin{nscenter}
    \chessboard[
        showmover=true,
        % mover=b,
